                ...
                <thead class="bg-gradient-to-r from-blue-500 to-purple-600 text-white">
                    <tr>
                        ...
                        <th class="py-4 px-2 sm:px-4 text-center text-xs font-medium uppercase tracking-wide">Tanggal
                            Pengecekan</th>
                        <th class="py-4 px-2 sm:px-4 text-center text-xs font-medium uppercase tracking-wide">Actions</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-200">
                    @foreach ($dashboardList as $index => $dashboard)
                        <tr class="hover:bg-gray-50 transition duration-200 ease-in-out">
                            ...
                            <td class="py-4 px-2 sm:px-4 text-gray-700 text-center text-xs">{{ $dashboard->nama_pelanggan }}
                            </td>
